...
export default function cart() {
  return (
    <>
      <Header />
      <div className="w-screen bg-gray-900 flex justify-center">
        <div className="flex flex-col md:w-[60vw] p-6 space-y-4 sm:p-10  text-gray-100">
          ...
          <ul className="flex flex-col divide-y divide-gray-700">
            ...
            <li className="flex flex-col py-6 sm:flex-row sm:justify-between">
              <div className="flex w-full space-x-2 sm:space-x-4">
                <img
                  className="flex-shrink-0 object-cover w-20 h-20  border-transparent rounded outline-none sm:w-32 sm:h-32  bg-gray-500"
                  src="https://images.unsplash.com/pho to-1594549181132-9045fed330ce?ixid=MXwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHw%3D&amp;ixlib=rb-1.2.1&amp;auto=format&amp;fit=crop&amp;w=675&amp;q=80"
